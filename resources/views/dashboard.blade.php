        ...
        <div class="bg-white basis-1/3 py-20 px-5 shadow-sm rounded-lg hover:bg-[#D3D8F8] duration-300">
            ...
            <div class="max-w-md mt-14">
                <p class="text-gray-400 font-medium text-start pl-2">
                    Estamos buscando um desenvolvedor com experiência em JavaScript, PHP e MySQL para integrar nosso time.
                    A vaga exige habilidades em desenvolvimento de soluções dinâmicas, criação de APIs e otimização de banco de dados.
                </p>
            </div>
        </div>
